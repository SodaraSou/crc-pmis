                ...
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-tabs-four-honor-tab" data-toggle="pill"
                            ...
                            aria-selected="true">គណ:កិត្តិយសសាខា</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-committee-tab" data-toggle="pill"
                            ...
                            aria-selected="false">គណ:កម្មាធិការសាខា</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-employee-tab" data-toggle="pill"
                            ...
                            aria-selected="false">មន្ត្រីប្រតិបត្តិសាខា</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                    ...
                    <div class="tab-pane fade" id="custom-tabs-four-committee" role="tabpanel"
                        ...
                        <livewire:branch.branch-committee-member-table :branch="$branch" />
                    </div>
