    ...
    <form wire:submit.prevent="save">
        <div class="card-body">
            <div class="form-group">
                <label>គណៈកម្មាធិការ</label>
                <select wire:model="committee_id" class="form-control" disabled>
                    <option value="">សូមជ្រើសគណៈកម្មាធិការ</option>
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-success">
                <i class="fa fa-save mr-1"></i> រក្សាទុក
            </button>
        </div>
    </form>
</div>
