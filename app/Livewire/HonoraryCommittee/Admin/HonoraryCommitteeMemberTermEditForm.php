...
class HonoraryCommitteeMemberTermEditForm extends Component
{
    public $branch_id = '';
    public $branches = [];
    ...
    public function save()
    {
        ...
        try {
            ...
            return redirect()->to("/honorary-committee/member/{$this->committee_member->member_id}/edit");
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.honorary-committee.admin.honorary-committee-member-term-edit-form');
    }
}
